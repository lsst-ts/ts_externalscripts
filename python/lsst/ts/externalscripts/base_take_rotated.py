...
class BaseTakeRotated(BaseTakeAOSSequence):
    """Take AOS sequences at different rotator angles.
    ...
    **Checkpoints**
    ...
    def __init__(self, index):
        super().__init__(index=index, descr="Take AOS sequence at rotated positions.")
    ...
    def get_schema(cls):
        ...
        schema_dict["$id"] = (
            "https://github.com/lsst-ts/ts_externalscripts/maintel/BaseTakeRotated.yaml"
        )
        schema_dict["title"] = "BaseTakeRotated v1"
        schema_dict["description"] = "Configuration for BaseTakeRotated."
