...
from lsst.ts.standardscripts.maintel.parameter_march_lsstcam import ParameterMarchLSSTCam
...
class TestParameterMarchLSSTCam(
    ...
    async def test_parameter_march(self):
        ...
        async with self.make_script():
            ...
            assert self.script.lsstcam.take_acq.call_count == config["n_steps"]
