...
class TestTakeRotatedComCam(
    ...
    async def test_configure(self):
        async with self.make_script():
            ...
            assert self.script.angles == angles
    ...
    async def test_run(self):
        async with self.make_script():
            ...
            expected_wait_calls = len(angles)
            ...
            self.assertEqual(
                self.script.mtcs.wait_for_inposition.await_count,
                expected_wait_calls,
                f"wait_for_inposition was called {self.script.mtcs.wait_for_inposition.await_count} times, "
                f"expected {expected_wait_calls}",
            )
