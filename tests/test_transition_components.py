...
from lsst.ts.externalscripts.scripts import TransitionComponents
...
class TestTransitionComponents(unittest.TestCase):
    ...
    def test_transition_components(self):
        ...
        async def doit():
            ...
            component = f'Test:{harness.test_index}'
            invalid_transition_to = 'FOO'
            valid_transition_up = 'start,enable'
            valid_transition_down = 'disable, standby'  # test with spaces in the name
